...
|---|---|---|---|
| Pricing | Free, costs time | $20 to $99 per month | Pay per item, first 2 free |
...
First 2 items per run are free. After that you pay per extracted item. No seats. No tier gating. A 500 item run lands under $1 on the Apify free plan.

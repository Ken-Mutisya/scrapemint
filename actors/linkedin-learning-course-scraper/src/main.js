// linkedin-learning-course-scraper — RETIRED (fail-fast stub)
//
...
log.warning('linkedin-learning-course-scraper is retired and no longer returns data. No charges are applied.');

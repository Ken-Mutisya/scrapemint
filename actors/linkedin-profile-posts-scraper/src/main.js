// linkedin-profile-posts-scraper — RETIRED (fail-fast stub)
//
...
log.warning('linkedin-profile-posts-scraper is retired and no longer returns data. LinkedIn now login-walls anonymous access to member activity feeds, so a cookieless scraper cannot return post data. No charges are applied.');

await Actor.pushData({
    retired: true,
    message: 'This actor has been retired. LinkedIn now login-walls anonymous access to member activity feeds, so a cookieless scraper cannot return post data. You have not been charged.',
